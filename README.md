...
<H2> commissioned by Bob Filligen </H2>
...
# Create Env File
<p>TOKEN = discord bot token /t
  DIS_SERVER_ID = discord server id of server bot will be in /t
...
## Apis:
  discord & discord js - collecting answer and voice activity from contestants
